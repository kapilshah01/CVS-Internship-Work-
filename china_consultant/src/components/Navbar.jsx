...
export default function Navbar({ onToggleDarkMode, isDark }) {
  ...
  return (
    <>
      ...
      >
        <div className="navbar__inner">
          ...
          <div className="navbar__actions">
            ...
            <Link to="/login" className="btn btn--sm btn--outline" style={{ borderColor: 'rgba(255,255,255,0.3)', color: '#fff' }}>
              Login
            </Link>
      ...
      <div className={`mobile-menu ${menuOpen ? 'mobile-menu--open' : ''}`} role="dialog" aria-label="Mobile menu">
        ...
        <Link to="/login" className="btn btn--primary btn--lg" onClick={() => setMenuOpen(false)}>
          Login / Register
        </Link>
      </div>
    </>
